...
public interface OrderInfoMapper {
    ...
    OrderInfo.OrderItemOptionGroup of(OrderInfo.OrderItemOptionGroup orderItemOptionGroup);

    OrderInfo.OrderItemOption of(OrderInfo.OrderItemOption orderItemOption);
}
